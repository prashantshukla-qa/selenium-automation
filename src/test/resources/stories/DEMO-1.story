...
Then I see the error message 'No matching record was found. Check your spelling and try again.'
...
Then I see the error message 'ENTER YOUR EMAIL ADDRESS'
...
Then I see the error message 'ENTER YOUR PASSWORD'
